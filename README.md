...
**Análise por Projeto**
![Análise por Projeto](AnaliseProjeto.png)

**GIF demonstrativo — Visão Geral**
![Demonstração Visão Geral](VisaoGeral.gif)

**GIF demonstrativo — Análise por Projeto**
![Demonstração Análise por Projeto](AnaliseProjeto.gif)
...
1. Baixe o arquivo [`Faturas.pbix`](Faturas.pbix) deste repositório
2. Abra no Power BI Desktop (gratuito)
3. Use o filtro de Data (canto superior) para ajustar o período analisado
4. Use o filtro de Projeto (na página "Análise por Projeto") para investigar um projeto específico
5. Passe o mouse sobre os gráficos para ver detalhes adicionais nos tooltips

## 👤 Autor

**Lidson Mendes Ramos**
📍 Rio de Janeiro, RJ
✉️ [lidson.mendes@gmail.com](mailto:lidson.mendes@gmail.com)
🔗 [LinkedIn](https://www.linkedin.com/in/lidsonmendes/) · [GitHub](https://github.com/lidsonmendes)
